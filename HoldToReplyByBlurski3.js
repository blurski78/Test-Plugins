// THIS IS THE CORRECT FORMAT FOR IPA ENMITY
...
function HoldToReply() {
  this.patch = null;
  this.name = "HoldToReply";
  this.version = "1.0.0";
  this.description = "Hold notification banner for 2 seconds to open reply box";
  this.author = "Blurski";
  this.manifest = {
    name: "HoldToReply",
    ...
    color: "#5865F2",
    spec: "1",
    authors: [{ name: "Blurski", id: "1497358039718821981" }],
    version: "1.0.0"
  };
}

HoldToReply.prototype.start = function() {
  console.log("[HoldToReply] Started");
...
HoldToReply.prototype.injectOverlay = function(notif) {
...
HoldToReply.prototype.openReplyBox = function() {
...
HoldToReply.prototype.removeOverlay = function() {
...
HoldToReply.prototype.stop = function() {
  if (this.patch) uninject(this.patch);
  this.removeOverlay();
  if (animFrame) cancelAnimationFrame(animFrame);
};

// THIS IS THE CRITICAL PART FOR IPA
module.exports = {
  default: HoldToReply,
  manifest: {
    name: "HoldToReply",
